...
//Locators
	// @AndroidFindBy(id="com.amazon.mShop.android.shopping:id/skip_sign_in_button")private
	// List <WebElement> skip_signin;

	public void clickSearch(AndroidDriver driver, String productname) {
		List<WebElement> skip_signin = driver
				.findElements(By.id("com.amazon.mShop.android.shopping:id/skip_sign_in_button"));
	...
	public void addproducttoCart(AndroidDriver driver) {
		scrollUp(driver);
		List <WebElement> searchelement = driver.findElements(By.xpath("//android.view.View[contains(@text,'RAVIAD')]"));
